...
const KEY = 'championsRankedSinglesSpeedQuizV7';
const state = Object.assign({ total: 0, correct: 0, streak: 0, wrong: [] }, loadSavedState(KEY));
...
function renderSummary() {
  ...
  $('#summary').innerHTML = `
    <div class="box"><strong>2026.07.02</strong><span>사용률 업데이트</span></div>
